...
## ----------------------------------------------------------------------------
set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports FMC_CLK0_N]
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports FMC_CLK0_P]
create_clock -period 20.000 [get_ports FMC_CLK0_P]

set_property -dict {PACKAGE_PIN M20 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports FMC_LA00_CC_N]
set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports FMC_LA00_CC_P]
create_clock -period 1.667 [get_ports FMC_LA00_CC_N]
...
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVDS_25} [get_ports FMC_LA02_N]
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVDS_25} [get_ports FMC_LA02_P]
set_property -dict {PACKAGE_PIN P22 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports FMC_LA03_N]
set_property -dict {PACKAGE_PIN N22 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports FMC_LA03_P]
set_property -dict {PACKAGE_PIN M22 IOSTANDARD LVDS_25} [get_ports FMC_LA04_N]
set_property -dict {PACKAGE_PIN M21 IOSTANDARD LVDS_25} [get_ports FMC_LA04_P]
#set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports FMC_LA05_N]
#set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports FMC_LA05_P]
#set_property -dict {PACKAGE_PIN L22 IOSTANDARD LVDS_25} [get_ports FMC_LA06_N]
#set_property -dict {PACKAGE_PIN L21 IOSTANDARD LVDS_25} [get_ports FMC_LA06_P]
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports FMC_LA07_N];  # "FMC-LA07_N"
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports FMC_LA07_P];  # "FMC-LA07_P"
set_property -dict {PACKAGE_PIN J22 IOSTANDARD LVDS_25} [get_ports FMC_LA08_N];  # "FMC-LA08_N"
set_property -dict {PACKAGE_PIN J21 IOSTANDARD LVDS_25} [get_ports FMC_LA08_P];
...
## ----------------------------------------------------------------------------
set_property -dict {PACKAGE_PIN C19 IOSTANDARD LVDS_25} [get_ports FMC_CLK1_N]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVDS_25} [get_ports FMC_CLK1_P]
...
# gearbox
set_false_path -from [get_pins -hier -filter {name =~ "*gearbox*ram*CLK"}] -to [get_pins -hier -filter {name =~ "*gearbox*r_rd_data_reg*D"}]

# elastic buffer
set_false_path -from [get_pins -hier -filter {name =~ "*async_fifo*ram*CLK"}] -to [get_pins -hier -filter {name =~ "*reg*D"}]
set_false_path -from [get_pins -hier -filter {name =~ "*async_fifo*gray*C"}] -to [get_pins -hier -filter {name =~ "*async_fifo*gray*D"}]

# synchronizer
set_false_path -to [get_pins -hier -filter {name =~ "*r_sync_reg*/C"}]
set_false_path -to [get_pins -hier -filter {name =~ "*r_sync_reg*/D"}]
set_false_path -to [get_pins -hier -filter {name =~ "*r_sync_reg*/CE"}]

# synchronizer
set_false_path -from [get_pins -hier -filter {name =~ "*r_sync_reg*/C"}]
set_false_path -from [get_pins -hier -filter {name =~ "*r_sync_reg*/D"}]
set_false_path -from [get_pins -hier -filter {name =~ "*r_sync_reg*/CE"}]

# async reset
set_false_path -from [get_pins -hier -filter {name =~ "*r_rst_reg*/C"}]

# handshake
set_false_path -from [get_pins -hier -filter {name =~ "*reg*C"}] -to [get_pins -hier -filter {name =~ "*cdc_mon*reg*D"}]
set_false_path -from [get_pins -hier -filter {name =~ "*cdc_mon*reg*C"}] -to [get_pins -hier -filter {name =~ "*reg*D"}]
set_false_path -from [get_pins -hier -filter {name =~ "*reg*C"}] -to [get_pins -hier -filter {name =~ "*cdc_mon*reg*CE"}]
